...
INSTANCE_ID="${INSTANCE_ID:-i-01c180158b5dd90e1}"
...
usage() {
  cat <<EOF
Usage:
  REGION=us-east-2 INSTANCE_ID=i-01c180158b5dd90e1 DB_ID=mydlab-mysql ./gate_network_db.sh
...
Examples:
  REGION=us-east-2 INSTANCE_ID=i-01c180158b5dd90e1 DB_ID=lab-mysql ./gate_network_db.sh

  CHECK_PRIVATE_SUBNETS=true REGION=us-east-2 INSTANCE_ID=i-01c180158b5dd90e1 DB_ID=lab-mysql ./gate_network_db.sh
EOF
}
