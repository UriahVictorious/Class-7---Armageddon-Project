...
resource "aws_secretsmanager_secret" "bns-1c_db_secret09" {
  name = "${var.project_name}/rds_mysql_v9"
}

resource "aws_secretsmanager_secret_version" "bns-1c_db_secret09" {
  secret_id = aws_secretsmanager_secret.bns-1c_db_secret09.id
