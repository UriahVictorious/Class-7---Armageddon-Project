...
resource "aws_security_group" "bns-1c_vpce_sg1" {
  name        = "${local.bns_1c_prefix}_vpce_sg1"
...
resource "aws_instance" "bns-1c_ec2_private_bonus" {
  ...
  tags = {
    Name = "${local.bns_1c_prefix}_ec2_private"
  }
}
...
resource "aws_vpc_endpoint" "bns-1c_vpce_s3_gw1" {
  vpc_id            = aws_vpc.bns-1c_vpc1.id
  service_name      = "com.amazonaws.${data.aws_region.bns_1c_region01.name}.s3"
  ...
  tags = {
    Name = "${local.bns_1c_prefix}_vpce_s3_gw1"
  }
}
...
resource "aws_vpc_endpoint" "bns-1c_vpce_ssm1" {
  vpc_id              = aws_vpc.bns-1c_vpc1.id
  service_name        = "com.amazonaws.${data.aws_region.bns_1c_region01.name}.ssm"
  ...
  tags = {
    Name = "${local.bns_1c_prefix}_vpce_ssm1"
  }
}
...
resource "aws_vpc_endpoint" "bns-1c_vpce_ec2messages1" {
  vpc_id              = aws_vpc.bns-1c_vpc1.id
  service_name        = "com.amazonaws.${data.aws_region.bns_1c_region01.name}.ec2messages"
  vpc_endpoint_type   = "Interface"
  private_dns_enabled = true
  ...
  tags = {
    Name = "${local.bns_1c_prefix}_vpce_ec2messages1"
  }
}
...
resource "aws_vpc_endpoint" "bns-1c_vpce_ssmmessages01" {
  vpc_id              = aws_vpc.bns-1c_vpc1.id
  service_name        = "com.amazonaws.${data.aws_region.bns_1c_region01.name}.ssmmessages"
  vpc_endpoint_type   = "Interface"
  private_dns_enabled = true
  ...
  tags = {
    Name = "${local.bns_1c_prefix}_vpce_ssmmessages1"
  }
}
...
resource "aws_vpc_endpoint" "bns-1c_vpce_logs1" {
  vpc_id              = aws_vpc.bns-1c_vpc1.id
  service_name        = "com.amazonaws.${data.aws_region.bns_1c_region01.name}.logs"
  vpc_endpoint_type   = "Interface"
  private_dns_enabled = true
  ...
  tags = {
    Name = "${local.bns_1c_prefix}_vpce_logs1"
  }
}
...
resource "aws_vpc_endpoint" "bns-1c_vpce_secrets1" {
  vpc_id              = aws_vpc.bns-1c_vpc1.id
  service_name        = "com.amazonaws.${data.aws_region.bns_1c_region01.name}.secretsmanager"
  vpc_endpoint_type   = "Interface"
  private_dns_enabled = true
  ...
  tags = {
    Name = "${local.bns_1c_prefix}_vpce_secrets1"
  }
}
...
resource "aws_secretsmanager_secret" "bns-1c_db_secret06" {
  name = "${var.project_name}/rds_mysql_v6"
}

resource "aws_secretsmanager_secret_version" "bns-1c_db_secret06" {
  secret_id = aws_secretsmanager_secret.bns-1c_db_secret06.id
